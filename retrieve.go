...
var (
	...
	// "cпецслужбы":                   "military_special", // "автомобили и пдд":             "auto_regulations", // "альтернативная история":       "sf_history", // "альтернативная медицина":      "sci_medicine_alternative",
	// "аналитическая химия":          "sci_anachem", // "анекдоты":                     "humor_anecdote", // "антисоветская литература":     "dissident", // "античная литература":          "antique_ant", // "аппаратное обеспечение":       "comp_hard",
	// "архитектура":                  "architecture_book", // "астрология":                   "astrology", // "астрономия и космос":          "sci_cosmos", // "афоризмы":                     "aphorisms", // "базы данных":                  "comp_db",
	// "банковское дело":              "banking", // "басни":                        "fable", // "биографии и мемуары":          "nonf_biography", // "биология":                     "sci_biology",
	// "биофизика":                    "sci_biophyƒs", // "биохимия":                     "sci_biochem", // "боевая фантастика":            "sf_action", // "боевик":                       "det_action",
	// "боевые искусства":             "military_arts", // "ботаника":                     "sci_botany", // "буддизм":                      "religion_budda", // "бухучет и аудит":              "accounting",
	// "былины":                       "epic", // "в стихах":                     "in_verse", // "верлибры":                     "vers_libre", // "вестерн":                      "adv_western",
	// "ветеринария":                  "sci_veterinary", // "визуальная поэзия":            "visual_poetry", // "внешняя торговля":             "global_economy", // "водевиль":                     "vaudeville",
	// "военная документалистика":     "nonf_military", // "военная история":              "military_history", // "военная техника и вооружение": "military_weapon", // "военное дело: прочее":         "military",
	// "газеты и журналы":             "periodic", // "геология и география":         "sci_geo", // "героическая фантастика":       "sf_heroic", // "городское фэнтези":            "sf_fantasy_city",
	// "государство и право":          "sci_state", // "готический роман":             "gothic_novel", // "дамский детективный роман":    "det_cozy", // "деловая литература":           "sci_business",
	// "делопроизводство":             "paper_work", // "детективная фантастика":       "sf_detective", // "детективы: прочее":            "detective", // "детская литература: прочее":   "children", // "детская проза":                "child_prose",
	// "детская психология":           "psy_childs", // "детская фантастика":           "child_sf", // "детские остросюжетные":        "child_det", // "детские приключения":          "child_adv",
	// "детские стихи":                "child_verse", // "детский фольклор":             "child_folklore", // "документальная литература":    "nonfiction", // "домашние животные":            "home_pets",
	// "домоводство":                  "home", // "драма":                        "drama", // "драматургия: прочее":          "dramaturgy", // "древневосточная литература":   "antique_east",
...
func (gs *GenreSubstitutions) Create() {
	...
	*gs = append(*gs, DirectMatch...)
	*gs = append(*gs, WildMatch...)
}
